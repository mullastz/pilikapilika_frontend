...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Containers', route: '/admin/containers', icon: 'fa-solid fa-container-storage' },
  { label: 'Packages', route: '/admin/packages', icon: 'fa-solid fa-cubes' },
  { label: 'Addresses', route: '/admin/addresses', icon: 'fa-solid fa-location-dot' },
  { label: 'QR Codes', route: '/admin/qr-codes', icon: 'fa-solid fa-qrcode' },
  { label: 'Reviews', route: '/admin/reviews', icon: 'fa-solid fa-star' },
  { label: 'Payments', route: '/admin/payments', icon: 'fa-solid fa-credit-card' },
  { label: 'Verifications', route: '/admin/verifications', icon: 'fa-solid fa-envelope-circle-check' },
  { label: 'Reset Tokens', route: '/admin/reset-tokens', icon: 'fa-solid fa-key' },
  { label: 'User Keys', route: '/admin/user-keys', icon: 'fa-solid fa-lock' },
